<?php
    namespace Wezom\Modules\Specialists\Controllers;
    ...
    use Wezom\Modules\Specialists\Models\Specialists AS Model;

    class Specialists extends \Wezom\Modules\Base {

        public $tpl_folder = 'Specialists';
        public $page;
        public $limit;
        public $offset;
        ...
        function before() {
            parent::before();
            $this->_seo['h1'] = __('Специалисты');
            $this->_seo['title'] = __('Специалисты');
            $this->setBreadcrumbs(__('Специалисты'), 'wezom/'.Route::controller().'/index');
