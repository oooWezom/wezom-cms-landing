  ...
  $.extend(prototype, {
    ...
    initCropBox: function () {
      var options = this.options,
          ...
          minCropBoxWidth = num(options.minCropBoxWidth) || 200,
    ...
    renderCropBox: function () {
      var options = this.options,
          ...
          cropBox = this.cropBox;
          cropBox.minWidth = this.$preview[0].clientWidth * (this.image.width / this.image.naturalWidth);
          cropBox.minHeight = cropBox.minWidth / this.options.aspectRatio;
      ...
      if (options.movable) {
        $cropBox.find('.cropper-face').data('drag', (Math.round(cropBox.width) === Math.round(containerWidth) && Math.round(cropBox.height) === Math.round(containerHeight)) ? 'move' : 'all');
      }
