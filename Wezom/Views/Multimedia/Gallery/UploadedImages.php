                    ...
                    <?php if(\Core\User::god() || \Core\User::get_access_for_controller('gallery') == 'edit'): ?>
                        <div class="loadedCtrl loadedCover">
                            <label>
                                ...
                                <ins></ins>
                                <span class="btn btn-success" alt="<?php echo __('На главной'); ?>"><i class="fa fa-bookmark-empty"></i></span>
                        ...
                        <div class="loadedCtrl loadedCheck">
                            <label>
                                <input type="checkbox">
                                <ins></ins>
                                <span class="btn btn-info" alt="<?php echo __('Отметить'); ?>"><i class="fa fa-check-empty"></i></span>
                                <div class="checkInfo"></div>
                            </label>
                        </div>
                    <?php endif; ?>
                    <div class="loadedCtrl loadedView">
                        <button class="btn btn-primary btnImage" alt="<?php echo __('Просмотр'); ?>" href="<?php echo Core\HTML::media('images/gallery_images/big/'.$im->image); ?>"><i class="fa fa-zoom-in"></i></button>
                    </div>
                    <?php if(\Core\User::god() || \Core\User::get_access_for_controller('gallery') == 'edit'): ?>
                        <div class="loadedCtrl">
                            <button class="btn btn-warning" alt="<?php echo __('Редактировать'); ?>" href="<?php echo \Core\General::crop('gallery_images', 'small', $im->image, $_SERVER['HTTP_REFERER']); ?>"><i class="fa fa-pencil"></i></button>
                        </div>
