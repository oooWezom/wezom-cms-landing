<?php use Core\HTML; ?>
    <div class="myInformation">
        ...
        <div class="infoValue">
            <?php if ($user->name): ?>
                <?php echo $user->name; ?>
            <?php else: ?>
                <a href="<?php echo HTML::link('account/profile'); ?>">Не указано</a>
            <?php endif ?>
        </div>
    </div>
    <div class="myInformation">
    ...
    <div class="lkLinks">
        <div class="lkLink"><a href="<?php echo HTML::link('account/profile'); ?>">Редактировать личные данные</a>
        </div>
        <div class="lkLink"><a href="<?php echo HTML::link('account/change_password'); ?>">Изменить пароль</a></div>
    </div>
