        ...
        <div class="widget">
            <div class="widgetHeader" style="padding-bottom: 10px;">
                <?php echo \Forms\Form::open(['class' => 'widgetContent filterForm', 'action' => '/wezom/'.Core\Route::controller().'/index']); ?>
                    ...
                    <div class="col-md-2">
                        <?php echo \Forms\Builder::select(\Core\Support::selectData($answers, 'status', 'status', ['', 'Все']),
                            Core\Arr::get($_GET, 'status'), [
                                'name' => 'status',
                            ], __('Ответ сервера')); ?>
                    </div>
                    <div class="col-md-2">
                        <?php echo \Forms\Builder::select(\Core\Support::selectData($devices, 'device', 'device', ['', 'Все']),
                            Core\Arr::get($_GET, 'device'), [
                                'name' => 'device',
                            ], __('Устройство')); ?>
                    </div>
                    <div class="col-md-2">
                        <?php $options = [
                            'updated_at-desc' => __('По дате последнего обновления Я -> А'),
                            'updated_at-asc' => __('По дате последнего обновления А -> Я'),
