<?php
    namespace Wezom\Modules\Projects\Controllers;
    ...
    use Wezom\Modules\Projects\Models\Projects AS Model;

    class Projects extends \Wezom\Modules\Base {

        public $tpl_folder = 'Projects';
        public $page;
        public $limit;
        public $offset;
        ...
        function before() {
            parent::before();
            $this->_seo['h1'] = __('Проекты');
            $this->_seo['title'] = __('Проекты');
            $this->setBreadcrumbs(__('Проекты'), 'wezom/'.Route::controller().'/index');
        ...
        function deleteAction() {
            ...
            Files::deleteImage('case_chart', $page->chart);
            Files::deleteImage('case_screen', $page->screen);
            Model::delete($id);
