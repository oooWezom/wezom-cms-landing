            ...
            <div class="widgetContent">
                <div class="form-vertical row-border">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <?php if (is_file( HOST.Core\HTML::media('images/arguments/'.$obj->image) )): ?>
                                <div class="contentImageView">
                                    <a href="<?php echo Core\HTML::media('images/arguments/'.$obj->image); ?>" class="mfpImage">
                                        <img src="<?php echo Core\HTML::media('images/arguments/'.$obj->image); ?>" />
                                    </a>                                    
                                </div>
