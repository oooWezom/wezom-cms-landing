    ...
    class GeoObject
    {
        ...
        public function __construct(array $rawData)
        {
            ...
            array_walk_recursive($rawData, function($value, $key) use(&$data) {
                if (in_array($key, ['CountryName', 'CountryNameCode', 'AdministrativeAreaName', 'SubAdministrativeAreaName', 'LocalityName', 'DependentLocalityName', 'ThoroughfareName', 'PremiseNumber'])) {
                    $data[$key] = $value;
                }
            });
