	...
	public function setLocale($locale = 'en_us') {
		...
		if (in_array($language,self::$_validLocaleLanguages)) {
			...
			if ($locale != 'en_us') {
				...
				$functionNamesFile = PHPEXCEL_ROOT . 'PHPExcel'.DS.'locale'.DS.str_replace('_',DS,$locale).DS.'functions';
				if (!file_exists($functionNamesFile)) {
					//	If there isn't a locale specific function file, look for a language specific function file
					$functionNamesFile = PHPEXCEL_ROOT . 'PHPExcel'.DS.'locale'.DS.$language.DS.'functions';
					if (!file_exists($functionNamesFile)) {
						return FALSE;
					}
				}
				...
				$configFile = PHPEXCEL_ROOT . 'PHPExcel'.DS.'locale'.DS.str_replace('_',DS,$locale).DS.'config';
				if (!file_exists($configFile)) {
					$configFile = PHPEXCEL_ROOT . 'PHPExcel'.DS.'locale'.DS.$language.DS.'config';
				}
				if (file_exists($configFile)) {
