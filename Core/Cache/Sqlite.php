 ...
 */
class Sqlite extends \Core\Cache implements Tagging, GarbageCollect
{
    ...
    protected function __construct(array $config)
    {
        ...
        if ($database === NULL) {
            die('Database path not available in Kohana Cache configuration');
        }
        ...
        if (0 == count($result)) {
            ...
            if ($database_schema === NULL) {
                die('Database schema not found in Kohana Cache configuration');
            }
            ...
            try {
                ...
                die('Failed to create new SQLite caches table with the following error : ' . $e->getMessage());
            }
        }
    }
    ...
    public function get($id, $default = NULL)
    {
        ...
        try {
            ...
            die('There was a problem querying the local SQLite3 cache. ' . $e->getMessage());
        }
